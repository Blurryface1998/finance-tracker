...
const PROGRESS_PATH = "M6.4 64 A57.6 57.6 0 0 1 121.6 64";
    ...
    <div className="graph">
      <div className="goal-gauge">
        ...
        >
          ...
          {/* Dynamic green progress */}
          <path
            className="goal-gauge__progress"
            d={PROGRESS_PATH}
            pathLength="100"
      ...
      <div className="goal-gauge__range">
        ...
        <p className="current">{formatAmount(current)}</p>

        <p className="goal">${formatAmount(goal)}</p>
      </div>
    </div>
  );
}
